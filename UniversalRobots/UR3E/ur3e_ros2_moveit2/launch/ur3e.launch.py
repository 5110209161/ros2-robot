...
def launch_setup(context, *args, **kwargs):
    ...
    ompl_planning_yaml = load_yaml("ur3e_ros2_moveit2", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Configuration
    controllers_yaml = load_yaml("ur3e_ros2_moveit2", "config/controllers.yaml")
    ...
    servo_yaml = load_yaml("ur3e_ros2_moveit2", "config/ur_servo.yaml")
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_package",
            default_value="ur3e_ros2_gazebo",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="ur3e_ros2_moveit2",
