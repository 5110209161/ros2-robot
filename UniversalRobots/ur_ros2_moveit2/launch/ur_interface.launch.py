...
def launch_setup(context, *args, **kwargs):
    ...
    ompl_planning_yaml = load_yaml("ur_ros2_moveit2", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Configuration
    controllers_yaml = load_yaml("ur_ros2_moveit2", "config/controllers.yaml")
    ...
    servo_yaml = load_yaml("ur_ros2_moveit2", "config/ur_servo.yaml")
...
def generate_launch_description():
    ...
    base_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare(LaunchConfiguration("description_package")), "/launch", "/ur_simulation.launch.py"
        ]),
        launch_arguments={
            "ur_type": LaunchConfiguration("ur_type"),
        }.items()
    ...
    return LaunchDescription(
        declared_arguments +
        [base_launch, OpaqueFunction(function=launch_setup)]
    )